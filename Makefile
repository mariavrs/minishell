...
#    Updated: 2023/02/21 18:11:04 by mvorslov         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC_LIST = minishell.c parser.c parser_utils.c run_exec_tree.c \
	spl_cmd_exec.c spl_cmd_redir.c parser_spl_cmd.c syntax_check.c \
